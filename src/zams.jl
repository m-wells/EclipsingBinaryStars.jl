...
"""
zams_radius(m::Mass) = ustrip(Msun, m)^0.7*Rsun
...
"""
zams_mass(r::Length) = ustrip(Rsun, r)^(1/0.7)*Msun
...
"""
zams_luminosity(m::Mass) = ustrip(Msun, m)^3.8*Lsun
...
Zero Age Main Sequence luminosity from mass
"""
zams_mass(l::Power) = ustrip(Lsun, l)^(1/3.8)*Msun
